...
public class DonateComment implements Serializable {
	...
	public DonateComment(){}
	
	public DonateComment(int donateNum, String id, String donation, String donateFinish, String donateTitle,
	...
	public String toString() {
		return "DonateComment [DonateNum=" + DonateNum + ", id=" + id + ", donation=" + donation + ", donateFinish="
