...
<div id="header-wrapper">
   ...
   <div id ="wrapper2">
     ...
     <table width="700" border="0" cellspacing="0" cellpadding="2" id="sub_print">
        <tr> 
          <td id="sub_print_1"><img src="/web_project/images/시설현황.PNG" alt="" /></td>
        </tr>

        <tr>
          <td style="line-height:22px;"><img src="/web_project/images/지하1층.PNG" alt="지식은 나누고 행복은 더하는 kosta 도서관" width="640" height="500" />
