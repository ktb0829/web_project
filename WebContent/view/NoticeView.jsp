				...
				<div class="col-xs-8">
					<table class="table table-bordered answerview">
						...
						<tbody>
							...
							<form action="<%=projectName%>/insert.notice?cmd=notice-delete" method="post"
								...
								<tr>
									...
									<a class="btn btn-default" href="<%=projectName%>/list.notice?cmd=notice-list">목록보기</a>
									<a class="btn btn-default" href="<%=projectName%>/modify.notice?cmd=notice-modifyform&num=<%=rec.getBoardNum()%>">수정하기</a>
