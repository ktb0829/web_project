...
<div id="header-wrapper">
   ...
   <div id ="wrapper2">
     ...
     <table width="700" border="0" cellspacing="0" cellpadding="2" id="sub_print">
        <tr> 
          <td id="sub_print_1"><img src="/web_project/images/길.PNG" alt="" /></td>
        </tr>

        <tr>
          <td style="line-height:22px;"><img src="/web_project/images/찾아오시는길.PNG" alt="지식은 나누고 행복은 더하는 kosta 도서관" width="640" height="500" />
          <td style="line-height:22px;"><img src="/web_project/images/찾아오시는길설명.PNG" alt="지식은 나누고 행복은 더하는 kosta 도서관" width="640" height="500" />  
            </td>
        </tr>
        <tr> 
