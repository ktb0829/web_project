         ...
         <div id="menu_top">    
         	<ul>
         		...
         		<li class="main_menu"><a href="library.library?cmd=main-search">자료검색</a><br/>
         			<ul id="hide">
         			<br/>
         			<li class="main_menu"><a href="library.library?cmd=main-search">도서 자료 검색</a></li><br/>	
				...
				<div class="col-xs-8">
					<table class="table table-bordered answerview">
						...
						<tbody>
								...
								<form action="<%=projectName%>/insert.answer?cmd=answer-modify" method="post"
...
<%-- 									<a class="btn btn-default" href="<%=projectName%>/modify.answer?cmd=answer-modify"> 수 정</a> --%>
