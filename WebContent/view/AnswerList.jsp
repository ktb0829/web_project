...
<%@ page import="board.answer.*" %>
<%@ page import="board.answer.mybatis.*" %>
...
<%
	...
	List<AnswerComment> mList = (List<AnswerComment>)request.getAttribute("list");
...
<!-- 				onclick="location.href='/board/post'">작성</button> -->
			...
			<% } // end else %>
				...
				<tr>
					<td colspan="1"><a class="btn btn-primary btn-lg" href="<%=projectName%>/insert.answer?cmd=answer-insert">글쓰기</a></td>
				</tr>
			</table>
